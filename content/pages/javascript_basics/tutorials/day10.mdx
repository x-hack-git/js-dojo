...
前回
[+JavaScript道場：九日目 / 配列と制御構文 for](/tutorials/9th_day)
...
- 改竄前
![改竄前](~/assets/images/10day_01.png)

- 改竄後（180万円の売り上げ！）
![180万の売り上げ！](~/assets/images/10day_02.png)
...
![HTML ツリー構造](~/assets/images/10day_03.png)
...
before
![](~/assets/images/10day_04.png)
after
![](~/assets/images/10day_05.png)
...
![document を consoleで実行した様子](~/assets/images/10day_06.png)
...
## 11日目
[+JavaScript道場：11日目 / DOM操作 その❷](/tutorials/11th_day)
